...
export class NotificationService {
  ...
  toastError(body: string, heading = '', sound = true) {
    const type = 'error';
  ...
  toastSuccess(body: string, heading = '', sound = true) {
    const type = 'success';
  ...
  toastInfo(body: string, heading = '', sound = true) {
    const type = 'info';
    const head = heading || this.mesNotice;
    if (sound) {
      this.playSoundConfirm();
  ...
  toastWarning(body: string, heading = '', sound = true) {
    const type = 'warn';
    const head = heading || this.messCaution;
    if (sound) {
      this.playSoundConfirm();
   ...
   * Alert Success
   * ***************************************************/
  alertSuccess(title: string, message: string, label: string = this.mesOk, sound = true): Promise<OvicButton> {
   ...
   * Alert Info
   * ***************************************************/
  alertInfo(title: string, message: string, label: string = this.mesOk, sound = true): Promise<OvicButton> {
    const options: AlertOptions = {
      type: 'info',
      hideClose: false,
   ...
   * Alert Warning
   * ***************************************************/
  alertWarning(title: string, message: string, label: string = this.mesOk, sound = true): Promise<OvicButton> {
    const options: AlertOptions = {
      type: 'warning',
      hideClose: false,
   ...
   * Alert Error
   * ***************************************************/
  alertError(title: string, message: string, label: string = this.mesOk, sound = true): Promise<OvicButton> {
    const options: AlertOptions = {
      type: 'error',
      hideClose: false,
   ...
   * Alert Confirm
   * ***************************************************/
  alertConfirm(title: string, message: string, label: string[] = [this.mesYes, this.mesNo], sound = true): Promise<OvicButton> {
    const options: AlertOptions = {
      type: 'question',
      hideClose: false,
